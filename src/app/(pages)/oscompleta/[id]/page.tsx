            ...
            <main id="sectionToCaptureScreen" className={styles.main}>
                ...
                <section className={styles.sectionContent}>
                    ...
                    <div className={styles.imposto}>
                        ...
                        <span className={styles.value} style={{ textAlign: "end" }}>Pequena taxa calculada com base no valor bruto multiplado pelo imposto.</span>
                    </div>
                    ...
                    <div className={styles.grauDeRiscoValor}>
                        ...
                        <span className={styles.value}>Valor total dos custos {((SearchByIdContent[0].fullOsValue / SearchByIdContent[0].degreeOfRisk).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }))} multiplicado por {SearchByIdContent[0].degreeOfRisk}</span>
                    </div>
